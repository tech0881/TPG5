		...
		<ul class="nav_ul_list">
			...
			<li class="nav_ul_list_li"><a href="http://localhost:8080/TPG5/site_pages/archive_attacks.jsp" title="DDoS Attacks">DDoS Attacks</a>
				<ul class="nav_ul_list_li_ul_">
					<li><a href="http://localhost:8080/TPG5/site_pages/user_dt_update.jsp">Add an Article</a></li>
					<li><a href="http://localhost:8080/TPG5/site_pages/monthly_attack.jsp">Monthly Attacks</a></li>
					<li><a href="http://localhost:8080/TPG5/site_pages/archive_attacks.jsp">View Archive Data</a></li>
				</ul>
				</li>
